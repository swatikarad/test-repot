...
$query="Insert into mehandi".
"(username,address,country,zip,email,mehandi)
 ".
...
?>
   ...
   <ul>
    ...
    <label for="mehandi">Mehandi<span>*</span>:</label> 
    <select name="mehandi">
    <option selected="" value="Default">(Please select a mehandi)</option>
    
    <option value="IM">Indian Mehndi Designs </option>
    <option value="AM">Arabic Mehndi Designs</option>
    <option value="AMD">African Mehndi Designs</option>
    <option value="PMD">Pakistani Mehndi Designs</option>
